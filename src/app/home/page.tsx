        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          <a
            ...
            style={{
              ...
              padding: '6px 10px', borderRadius: 6, transition: 'background 150ms',
            }}
...
export default function HomePage() {
  return (
    <Suspense fallback={<div style={{ display: 'flex', height: '100vh', alignItems: 'center', justifyContent: 'center', color: '#888' }}>Loading...</div>}>
      <HomeContent />
    </Suspense>
  )
}
