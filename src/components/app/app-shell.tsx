      ...
      <aside style={{
        ...
        <div style={{
          ...
          <button
            ...
            onMouseEnter={(event) => { event.currentTarget.style.color = '#555' }}
            onMouseLeave={(event) => { event.currentTarget.style.color = '#bbb' }}
          >
          ...
          {NAV.map(({ href, label, match, Icon }) => {
            ...
            return (
              <a
                ...
                onMouseEnter={(event) => {
                  if (!isActive) {
                    event.currentTarget.style.background = '#f5f5f7'
        ...
        <div style={{
          ...
          {!collapsed && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
              ...
              <div style={{ minWidth: 0, flex: 1 }}>
                ...
                <div style={{ fontSize: 11, color: tier === 'pro' ? '#6366f1' : '#bbb', marginTop: 1, fontWeight: tier === 'pro' ? 600 : 400 }}>
                  {tier === 'pro' ? 'Pro' : t.nav_free_plan}
                </div>
              </div>
            </div>
          )}
          ...
          <button
            ...
            onMouseLeave={(event) => {
              ...
              event.currentTarget.style.borderColor = '#ebebed'
            }}
          >
